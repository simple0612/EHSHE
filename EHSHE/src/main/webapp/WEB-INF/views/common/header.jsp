...
<body>
	...
	<header>
		<nav>
			<div class="logo_area">
				<a href="${contextPath}"> <img id="logo_img"
					src="${contextPath}/resources/images/ehshe_final_logo.png">
				</a>
			</div>
			...
			<div class="login_area">
				<c:choose>
					...
					<c:otherwise>
						...
						<span><a href="${contextPath}/shop2/cart"><img
								src="${contextPath}/resources/images/shoppingCart.png"></a></span>
					</c:otherwise>
				</c:choose>
			</div>
		</nav>
	...
	<div class="side_menu">
		<div class="sidebar">
			<ul class="side1">
				...
				<li class="popup"><a href="${contextPath}/shop/shopMain">SHOP<i
			...
			<ul class="side2">
				<c:choose>
					...
					<c:otherwise>
						...
						<li><a href="${contextPath}/shop2/cart"><img
								src="${contextPath}/resources/images/shoppingCart.png"></a></li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
