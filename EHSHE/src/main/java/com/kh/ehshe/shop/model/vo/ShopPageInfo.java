...
public class ShopPageInfo {
	...
	private int shopType; 		// 게시글 타입

	public ShopPageInfo() {}

	public ShopPageInfo(int currentPage, int listCount, int shopType) {
		super();
	...
	public ShopPageInfo(int currentPage, int listCount, int limit, int pageSize, int shopType) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
